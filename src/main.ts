...
import '@fontsource/almendra/latin-700.css'; // Yharnam skin (tiles)
import '@fontsource/unifrakturmaguntia/latin-400.css'; // Yharnam skin (wordmark)
import '@fontsource/comfortaa/latin-700.css'; // Aero skin (tiles)
import '@fontsource/audiowide/latin-400.css'; // Aero skin (wordmark)
import '@fontsource/share-tech-mono/latin-400.css'; // Zebes skin (tiles)
import '@fontsource/russo-one/latin-400.css'; // Zebes skin (wordmark)
import '@fontsource/cinzel-decorative/latin-700.css'; // Hyrule Antique skin (wordmark)
import '@fontsource/titan-one/latin-400.css'; // Dream Land skin (wordmark)
import '@fontsource/pixelify-sans/latin-700.css'; // Kingdom skin (tiles)
import '@fontsource/bungee/latin-400.css'; // Kingdom skin (wordmark)
import '@fontsource/dotgothic16/latin-400.css'; // Dinosaur Land skin (tiles)
import '@fontsource/dela-gothic-one/latin-400.css'; // Dinosaur Land skin (wordmark)
import '@fontsource/rubik-mono-one/latin-400.css'; // Green Hill skin (tiles)
import '@fontsource/righteous/latin-400.css'; // Green Hill skin (wordmark)
import '@fontsource/rocknroll-one/latin-400.css'; // Kamurocho skin (tiles)
import '@fontsource/teko/latin-600.css'; // Kamurocho skin (wordmark)
import '@fontsource/permanent-marker/latin-400.css'; // Graffiti Soul skin (tiles)
import '@fontsource/luckiest-guy/latin-400.css'; // Graffiti Soul skin (wordmark)

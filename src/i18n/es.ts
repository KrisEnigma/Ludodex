...
export const strings: Record<keyof typeof enStrings, string> = {
  ...
  'settings.section_app_icon': 'Ícono de la app',
  ...
  // Skin descriptions
  'skin.void.desc':               'La cuadrícula en reposo. Líneas limpias, luz fría, sin distracciones.',
  'skin.lumen.desc':              'Como Void, pero con las persianas abiertas. Igual de enfocado.',
  'skin.neon-horizon.desc':       'Todo brillo, todo neón. Ya has corrido por estas calles.',
  'skin.laser-vector.desc':       'Arcade vectorial puro. Una recreativa del futuro.',
  'skin.maze-chase.desc':         'Wakka wakka. Vigila las esquinas.',
  'skin.swarm.desc':              'La mancha se expande. Mente colmena en línea. El enjambre no negocia.',
  'skin.phantom-thieves.desc':    'Cambio de corazón inminente. Es la hora del espectáculo.',
  'skin.catalyst.desc':           'La ciudad es una ruta. Tu cuerpo ya conoce el camino.',
  'skin.paleblood.desc':          'Busca la Paleblood para trascender la cacería.',
  'skin.aero.desc':               'Lo mejor del 2000. Degradados, brillo y optimismo tecnológico puro.',
  'skin.star-hunter.desc':        'Power Suit activado. Solo en la superficie. Navegación en línea.',
  'skin.relic-gold.desc':         'Esmeralda Kokiri. Ámbar de la Trifuerza. La mazmorra te llama.',
  'skin.puff-star.desc':          'Inhala. Copia. Flota. Dream Land te espera.',
  'skin.mushroom-kingdom.desc':   'Mundo 1-1. Las monedas están en las fichas.',
  'skin.cape-16bit.desc':         'Capa cargada. Yoshi ensillado. Sala bonus a la vista.',
  'skin.blue-blur.desc':          'Hay que ir rápido. Bucles de tablero, anillos dorados, sin frenos.',
  'skin.radio-tag.desc':          'Grindea los raíles. Taguea cada pared. Mantente fuera del radar.',
  'skin.cyber-shinobi.desc':      'Protocolo sombra activo. Golpea rápido. No dejes rastro.',
  'skin.dragon-heat.desc':        'Kamurocho, 3 AM. Neón sobre asfalto mojado. Alguien va a empezar una pelea.',
  'skin.gameboy.desc':            'Encender. Ese jingle de inicio nunca envejece.',
  'skin.terminal.desc':           'Cursor parpadeante. Texto verde. Acceso raíz concedido.',
  'skin.phosphor.desc':           'El resplandor de un monitor en una habitación oscura. No existe nada más.',
  'skin.bios.desc':               'Comprobación de memoria en curso. Los tres segundos más largos antes de empezar.',
  'skin.super-16-bit-lilac.desc': 'Modo 7. Botones de hombro. El ladrillo morado que lo redefinió todo.',
  'skin.toaster.desc':            'Sopla el cartucho. Ladrillo gris. Letras rojas. Leyenda pura.',
  'skin.lord-of-terror.desc':     'Quédate un rato y escucha. Tristram te está llamando.',
  'skin.test-chamber.desc':       'Fue un triunfo. La ciencia lo exigía.',
  'skin.polygon.desc':            'Ese sonido de arranque. Ese zumbido del disco. Aquí te convertiste en gamer.',
  'skin.ring-of-light.desc':      'Sin anillo rojo. Logro desbloqueado. Puntuación de jugador: máxima.',
  'skin.dream-spiral.desc':       'Está pensando. Siempre un paso por delante.',
  'skin.rip-tear.desc':           'Destroza y desgarra hasta que esté hecho.',
  'skin.crimson.desc':            'Música del jefe final. Sin punto de control. Todo adentro.',
  'skin.blood-darkness.desc':     'Zagreus no se detiene. Tú tampoco. Comienza otro intento de escapar.',
  ...
  'win.skin_unlocked_nudge':   '🎨 Nuevo skin desbloqueado — ver en Ajustes →',
  ...
  'how_to_play.step2_body': 'Personajes, ítems, estudios, hardware — todas las respuestas comparten un tema. Las respuestas son siempre en inglés, aunque juegues en español.',
  ...
  'dialog.change_icon_title': '¿Cambiar icono?',
  'dialog.change_icon_body': 'La aplicación se cerrará para aplicar el nuevo icono. Ábrela de nuevo para ver el cambio.',
  'dialog.change_icon_confirm': 'Cambiar',
